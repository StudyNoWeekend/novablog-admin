---
name: api-reference
description: novablog 全部公开接口完整参考文档，涵盖公开接口（无需认证），包括接口路径、请求方法、输入输出参数、错误码、请求/响应示例等
---
...
- [六、公开接口（无需认证）](#六公开接口无需认证)
  - [6.1 博主信息](#61-博主信息)
  - [6.2 文章模块（公开）](#62-文章模块公开)
  - [6.3 分类与标签（公开）](#63-分类与标签公开)
  - [6.4 评论模块（公开）](#64-评论模块公开)
  - [6.5 旅行攻略模块（公开）](#65-旅行攻略模块公开)
  - [6.6 摄影作品集模块（公开）](#66-摄影作品集模块公开)
  - [6.7 视频作品模块（公开）](#67-视频作品模块公开)
  - [6.8 音乐播放器模块（公开）](#68-音乐播放器模块公开)
- [七、数据脱敏规则](#七数据脱敏规则)
- [八、使用限制](#八使用限制)
